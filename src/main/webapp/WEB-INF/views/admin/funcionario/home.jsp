...
<title>Mobil - Admin Funcionário</title>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="/mobil/admin/funcionario">Funcionario</a></li>
		...
		<div class="row-fluid">
			<div class="col-md-12">
				<div class="btn-toolbar">
					<a class="btn btn-primary" href="/mobil/admin/funcionario/cadastro">Novo Funcionário</a>
				</div>
				<br />
				<div class="well">
